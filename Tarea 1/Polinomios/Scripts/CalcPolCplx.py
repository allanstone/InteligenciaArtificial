...
if __name__ == '__main__':
	...
	#Operaciones con complejos
		cplx1Real=float(input("Dame el valor de la parte real del primer complejo: "))
		cplx1Imag=float(input("Dame el valor de la parte imaginaria del primer complejo: "))
		cplx2Real=float(input("Dame el valor de la parte real del primer complejo: "))
		cplx2Imag=float(input("Dame el valor de la parte imaginaria del primer complejo: "))

		#instanciamos los complejos
		cplx1=CalcCplx(cplx1Real,cplx1Imag)
		cplx2=CalcCplx(cplx2Real,cplx2Imag)
		grado=2
		...
		print("Potencia de %s^%d = %s" %(cplx1,grado,cplx1.diviCplx(cplx2)))
